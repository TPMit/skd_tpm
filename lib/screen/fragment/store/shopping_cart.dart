...
class _ShoppingCartState extends State<ShoppingCart> implements ShoppingCartState {
          ...
          ListView(
            children: [
              ...
              _shoppingCartModel.getCartResponse.dataCart!.isEmpty
                        ...
                        : 
              ListView.builder(
                itemCount: _shoppingCartModel.getCartResponse.dataCart!.length,
                ...
                Row(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.network(
                                          'https://sis.mindotek.com/assets/images/products/' +
                                              _shoppingCartModel.getCartResponse.dataCart![index].images![0].fileName.toString(),
                                              width: 50,
                                              height: 50,
                                        ),
                    ),
                          ...
                          children: [
                            Container(
                              padding: const EdgeInsets.only(left: 14),
                                child: CustomText(
                                  text: _shoppingCartModel.getCartResponse.dataCart![index].title.toString(),
                                  color: Colors.black,
                                  size: 14,
                              ...
                              children: [
                                IconButton(
                                    icon: const Icon(
                                        Icons.chevron_left),
                                    onPressed: () {
                                _shoppingCartPresenter.qty(0, index, _shoppingCartModel.getCartResponse.dataCart![index].idCart.toString(),
                                                        GetStorage().read(
                                                            constant.idUser));
                                    }),
                                Padding(
                                  ...
                                  const EdgeInsets.all(
                                      8.0),
                                  child: CustomText(
                                    text: _shoppingCartModel.getCartResponse.dataCart![index].qty.toString(),
                                    color: Colors.black,
                                    size: 14,
                                    weight: FontWeight.bold,
                                  ),
                                ...
                                IconButton(
                                    icon: const Icon(Icons
                                        .chevron_right),
                                    onPressed: () {
                                      _shoppingCartPresenter.qty(1, index,
                                                        _shoppingCartModel
                                                            .getCartResponse
                                                            .dataCart![index]
                                                            .idCart
                    ...
                    Padding(
                      ...
                      child: CustomText(
                        text: "Rp."+ _shoppingCartModel.getCartResponse.dataCart![index].price.toString(),
                        size: 18,
                        weight: FontWeight.bold,
                        color: Colors.black,
                      ),
